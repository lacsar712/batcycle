...
func NewDryFSM(id model.TowerID, effect func(context.Context, model.TowerID, model.DryState, model.DryState) error) *DryFSM {
	_ = effect
	return &DryFSM{id: id, state: model.DryIdle, hooks: NewDryHookChain()}
}

func (f *DryFSM) Hooks() *DryHookChain { return f.hooks }

func (f *DryFSM) State() model.DryState { return f.state }

func (f *DryFSM) Dispatch(ctx context.Context, event string) (model.DryState, error) {
